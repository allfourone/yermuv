$(() => {
    ...
    let validatePawn = (piece, destination) => {
        //WH -switch statement for assigning pieces
        var chessPieceType = '';
        var chessPiece = piece.html().charCodeAt(0);
        switch (chessPiece) {
            case 9817:
                chessPieceType = 'pawn';
                break;
        ...
        //WH- assign unicode charcters to specific pieces
        /*   let pawn = 9817
           let rook = 9814
           let knight = 9816
           let bishop = 9815
        ...
        //WH- Setting piece rules for pawn piece only
